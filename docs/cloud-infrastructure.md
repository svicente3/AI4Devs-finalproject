# Cloud Infrastructure: Render, Neon, Firebase

Hosting and external services used by the **Coacher** production deployment.
For the Google Calendar / GCP setup see [`docs/infrastructure.md`](./infrastructure.md).
For local development see [`docs/setup.md`](./setup.md).
...
| **Google Cloud** | Google Calendar system-of-record (Service Account) | See `docs/infrastructure.md` |
